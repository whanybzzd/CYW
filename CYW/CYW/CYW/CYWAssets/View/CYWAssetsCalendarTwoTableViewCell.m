//
//  CYWAssetsCalendarTwoTableViewCell.m
//  CYW
//
//  Created by jktz on 2017/11/24.
//  Copyright © 2017年 jktz. All rights reserved.
//

#import "CYWAssetsCalendarTwoTableViewCell.h"
@interface CYWAssetsCalendarTwoTableViewCell()
...
@end
@implementation CYWAssetsCalendarTwoTableViewCell
...
- (void)initSubView{
    ...
    @weakify(self);
    [RACObserve(self, model) subscribeNext:^(CalendarMonthDetailViewModel *viewModel) {
        ...
        [self.repaymentsButton setTitle:[NSString stringWithFormat:@"第%i期",[viewModel.period intValue]] forState:UIControlStateNormal];
        
        self.Interestlabel.text=[NSString stringWithFormat:@"手续费:%.2lf元",[viewModel.fee floatValue]];
...
- (UIView *)lineView1{
    ...
    if (!_lineView1) {
        ...
        .leftSpaceToView(self.contentView, 0)
        .rightSpaceToView(self.contentView, 0)
        .topSpaceToView(_repaymentsButton, CGFloatIn320(12))
        .heightIs(1);
    }
    return _lineView1;
}
...
- (UIImageView *)claimsImageView{
    ...
    if (!_claimsImageView) {
        ...
        .leftSpaceToView(self.contentView, CGFloatIn320(10))
        .topSpaceToView(_lineView1, CGFloatIn320(12))
...
- (UILabel *)Interestlabel{
    ...
    if (!_Interestlabel) {
        ...
        .topSpaceToView(_lineView1, CGFloatIn320(14))
