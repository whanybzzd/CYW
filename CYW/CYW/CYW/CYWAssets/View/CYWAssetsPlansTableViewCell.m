...
@interface CYWAssetsPlansTableViewCell()
...
@end
@implementation CYWAssetsPlansTableViewCell
...
- (void)initSubView{
    ...
    @weakify(self);
    [RACObserve(self, model) subscribeNext:^(InterestCompleteViewModel *viewModel) {
