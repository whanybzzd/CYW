...
@property (nonatomic, retain) UILabel *kcastlabel;
...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        NSString *progressString = [NSString stringWithFormat:@"%.1f%%", _progress * 100.0];
        ...
        CGPoint origin = CGPointMake(center.x - expectedSize.width / 2.0, center.y - expectedSize.height / _textContentOff+5);
...
//                     clockwise:YES];
        [path addArcWithCenter:point radius:circleWidth startAngle:0.0 endAngle:360.0 clockwise:YES];
    }
...
//                      endAngle:DEGREES_TO_RADIANS(-90)
//                     clockwise:NO];
        [path addArcWithCenter:point radius:0.0 startAngle:0.0 endAngle:0.0 clockwise:NO];
    }
