...
- (UILabel *)label
{
    if(!_label)
    {
        _label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, WIDTH, (HEIGHT-self.progressWidth)/2)];
        _label.center = CGPointMake(WIDTH/2, (HEIGHT-self.progressWidth)/2+30);
        _label.textAlignment = NSTextAlignmentCenter;
        _label.textColor=[UIColor whiteColor];
        _label.font=[UIFont systemFontOfSize:CGFloatIn320(11)];
    }
    return _label;
}
@end
