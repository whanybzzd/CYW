...
- (void)setSelected:(BOOL)selected
{
    switch (_type) {
        ...
        {
            if (_titleLabel) {
                [_titleLabel setTextColor:(selected ? [UIColor colorWithHexString:@"#f52735"]:[UIColor colorWithHexString:@"#333333"])];
            }
            if (_titleIconView) {
...
- (void)Items:(NSArray *)titleItem selectedBlock:(XTSegmentControlBlock)selectedHandle{
...
- (void)setupUI_IsIcon:(BOOL)isIcon Items:(NSArray *)titleItem
{
    _contentView = ({
        ...
        scrollView.backgroundColor = [UIColor colorWithHexString:@"0xFFFFFF"];
