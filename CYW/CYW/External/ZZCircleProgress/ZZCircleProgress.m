...
- (UILabel *)progresslabel{
    ...
    if (!_progresslabel) {
        ...
        _progresslabel.textColor=[UIColor colorWithHexString:@"#f52735"];
        _progresslabel.text=@"17.5%";
        _progresslabel.font=[UIFont systemFontOfSize:CGFloatIn320(25)];
        [self addSubview:_progresslabel];
        _progresslabel.sd_layout
        .centerXEqualToView(self)
        .topSpaceToView(self, CGFloatIn320(50))
        .heightIs(25);
        [_progresslabel setSingleLineAutoResizeWithMaxWidth:200];
    }
...
- (UILabel *)titlelabel{
    ...
    if (!_titlelabel) {
        ...
        _titlelabel.text=@"预计年化收益";
        _titlelabel.font=[UIFont systemFontOfSize:CGFloatIn320(12)];
        [self addSubview:_titlelabel];
        _titlelabel.sd_layout
        .centerXEqualToView(self)
        .topSpaceToView(_progresslabel, CGFloatIn320(10))
        .heightIs(12);
...
- (void)setProgress:(CGFloat)progress {
    ...
    timer=[NSTimer bk_scheduledTimerWithTimeInterval:0.005 block:^(NSTimer *timer) {
