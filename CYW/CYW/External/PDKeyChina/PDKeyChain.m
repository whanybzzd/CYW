...
static NSString * const kPDidentifierDictionaryKey = @"com.xxx.identifierdictionaryKey";
static NSString * const kPDidentifierKeyChainKey = @"com.xxx.identifierkeychainKey";
@implementation PDKeyChain


+ (void)keyChainidentifierSave:(NSString *)string {
    NSMutableDictionary *tempDic = [NSMutableDictionary dictionary];
    [tempDic setObject:string forKey:kPDidentifierDictionaryKey];
    [self save:kPDidentifierKeyChainKey data:tempDic];
}

+ (NSString *)keyChainidentifierLoad{
    NSMutableDictionary *tempDic = (NSMutableDictionary *)[self load:kPDidentifierKeyChainKey];
    return [tempDic objectForKey:kPDidentifierDictionaryKey];
}
