...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EAFeatureGuideView/EAFeatureGuideView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PQActionSheet/PQActionSheet.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YRJSONAdapter/YRJSONAdapter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZYQAssetPickerController/ZYQAssetPickerController.framework"
fi
